...
exports.config = exports.getTrueNetworkInstance = void 0;
...
var getTrueNetworkInstance = function () { return __awaiter(void 0, void 0, void 0, function () {
    var trueApi;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, sdk_1.TrueApi.create(exports.config.account.secret)];
            case 1:
                trueApi = _a.sent();
                return [4 /*yield*/, trueApi.setIssuer(exports.config.issuer.hash)];
            case 2:
                _a.sent();
                return [2 /*return*/, trueApi];
        }
    });
}); };
...
exports.config = {
    ...
    algorithm: {
        id: 115,
        path: 'acm',
        schemas: [schemas_1.fanScoreSchema]
    },
};
